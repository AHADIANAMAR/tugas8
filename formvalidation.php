...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	//source code untuk nama
	if (empty($_POST["nama"]))
	{
		$error_nama = "Nama todak boleh kosong";
	}
	else
	{
	...
	else
	{
		...
		if (!preg_match("/\b(?:(?:http?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i",$web))
		{
...
<div class="form-group row">
	...
	<div class="col-sm-10">
		<input type="text" name="web" class="form-control <?php echo($error_web !="" ? "is-invalid" : ""); ?>" id="email" placeholder="web" value="<?php echo $web; ?>"><span class="warning"><?php echo $error_web; ?></span>
	</div>
</div>
