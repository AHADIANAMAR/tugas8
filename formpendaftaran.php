...
<?php
//Pembuatan/Pendeklarasian Variabel
...
//Membuat percabangan if untuk POST METHOD
if ($_SERVER["REQUEST_METHOD"] == "POST"){
	//Source code untuk Jenis Pendaftaran
	...
	//Source code untuk Tanggal Masuk Sekolah
	...
	//Source code untuk Nomer Peserta Ujian
	...
	//Source code untuk Nama Lengkap
	if(empty($_POST["nama"])){
	...
	//Source code untuk Jenis Kelamin
	...
	//Source code untuk Tempat Lahir
	...
	//Source code untuk Tanggal Lahir
	...
	//Source code untuk Berkebutuhan Khusus
	...
	//Source code untuk Alamat Jalan
	...
	//Source code untuk Desa/Kelurahan
	if(empty($_POST["desa"])){
	...
	//Source code untuk Tempat Tinggal
	...
	//Source code untuk Moda Transportasi
	...
	//Source code untuk Penerima KPS/PKH/KIP
	...
	//Jika dari kodingan diatas tidak ada yang error maka data akan disimpan
...
//Menampilkan pesan untuk melihat sukses menyimpan data
echo $pesan_sukses;
?>
</body>
</html>